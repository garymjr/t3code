...
export interface NativeApi {
  ...
  orchestration: {
    getSnapshot: (input?: { hydratedThreadIds?: ThreadId[] }) => Promise<OrchestrationReadModel>;
    getThread: (input: OrchestrationGetThreadInput) => Promise<OrchestrationGetThreadResult>;
